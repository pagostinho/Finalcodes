...
if __name__ == "__main__":
	if len(sys.argv) != 6:
		...
		img_path = glob.glob("/home/irocs/Desktop/IROCS/NN/Perceptron/images/floor3/*.png")
		gt_path = glob.glob("/home/irocs/Desktop/IROCS/NN/Perceptron/groundtruth/floor3/*.png")
		...
		if img_path == 0:
			...
			gt = cv.imread(sys.argv[5])
			#ground truth of that image
			groundtruth = cv.imread(gt,cv.IMREAD_UNCHANGED)
